...
public class TeamSquad extends JFrame {
	public enum posstion {
		GK, CB, RB, LB, MC, DM, LW, RW, ST
	};
	...
	private void initComponets() {
		...
		this.JFrameTeamSqouad.setBackground(new Color(30, 144, 255));
		...
		panelAddPlayer.setBackground(new Color(224, 255, 255));
		...
		panelPlayers.setBackground(new Color(224, 255, 255));
		...
		panelDelPlayer.setBackground(new Color(224, 255, 255));
